...
#### for example >>>>>>  terraform apply -help
...
terraform output tf-example-public-ip    ## cikti olarak sadece tf-example-public-ip olani verir
```
...
```bash
$ terraform apply -refresh=false  ##bana sadece degidiklik olan kismi getir,cok kullanilmaz
