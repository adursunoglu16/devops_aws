...
$ eksctl create cluster \
 ...
 --nodes-max 3 \
 --ssh-access \
 --ssh-public-key  ~/.ssh/id_rsa.pub \    # veya burada --ssh-public-key pablokeys \  kullanabilirsin
 --managed
```
...
# reponun hepsini degil bir kismini aliyoz 
```shell
mkdir <repo>
cd <repo>
git init
...
```bash
$ eksctl get cluster --region us-east-1 or --region us-east-2
NAME            REGION
mycluster       us-east-2
$ eksctl delete cluster my-cluster # eksctl delete cluster --name  my-cluster --region us-east-2
```
