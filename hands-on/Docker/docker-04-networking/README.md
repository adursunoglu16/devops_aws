...
```bash
docker inspect clarus2nd |grep IPAddress      --->>>> 172.17.0.3
```
...
```bash
ping -c 4 clarus2nd   ---->>> default networklerde name ile ping yapamayiz ip ile yapabiliriz. name icin user defined ntws 
```
