...
```bash
docker-compose down     silmeden sadece stop icin docker-compose stop
```
- Now all containers are gone, to create containers again
```bash
docker-compose up -d
```
...
docker ps
```
# Hata problem falan var mi container icinde ararken container in icindeki loglara bakmak icin
```bash
docker logs -f <container_name>
```
# docker-compose ile ilgili komutlari docker-compose.yml file in oldugu dizinde olmamiz lazim. 